...
The user can choose between different types of contract templates. To create a contract, the user has to type the input on the form at the left side of the screen and check how the contract will look like on the right side.
The user can use the save button to save all the input he/she already typed.
When the user finishes making the contract, he/she can press finished and fill out his/her contact detail to receive the file in their e-mail. I still need to figure out how to convert a react component into a PDF file.

A link to your deployed project:

https://contract-generator-app.herokuapp.com/
